...
#define LC898214_HEX_MAX 0x7FFF //0x6A00
#define LC898214_HEX_MIN 0x8001 //0x9600
...
struct pixels_array_tt {
        struct pixel_tt pix[40];
        int     count;
};
/* HTC_END */
...
struct sensorb_cfg_data {
	...
	union {
        ...
        struct pixels_array_tt pixels_array;
        //HTC_END
};
